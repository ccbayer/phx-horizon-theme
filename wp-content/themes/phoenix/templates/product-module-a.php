...
$product_module = [
  ...
  'component_animation' => '',
  'id' => get_field('id') ?: $content['id'] ?: uniqid('prod-mod-a-')
];
...
<section id="<?= $product_module['id'] ?>"  class="product-module -version-a <?= $product_module['section_animation_options'] ?> off" <?= $product_module['component_animation']; ?>>
